...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        # 1st column
        self.btnBrowse1 = tk.Button(self.master, width=12, height=2, text="Browse...")
        ...
        self.txtField1 = tk.Entry(self.master, width=36, text='')
        self.txtField1.grid(row=0, column=1, rowspan=2, columnspan=3, padx=(10, 10), pady=(5, 5), sticky=W)
